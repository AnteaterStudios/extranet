...
public static partial class ExtensionMethods
{
    ...
    /// </summary>
    /// <typeparam name="TSource">The type of <paramref name="value"/>.</typeparam>
    ...
    public static TSource ConstrainToRange<TSource>(this TSource value, TSource min, TSource max)
